...
DartTracker::DartTracker(){
    ...
    poseReduction = dart::loadParamMapPoseReduction("/home/roboy/workspace/dart_tracker/src/dart_tracker/models/spaceJustin/justinHandParamMap.txt");
    ...
    tracker->addModel("/home/roboy/workspace/dart_tracker/src/dart_tracker/models/spaceJustin/spaceJustinHandRight.xml",
